...
const { EbayConnector, EtsyConnector, FacebookConnector, BonanzaConnector, ShopifyConnector, ShopifyListingError, WooCommerceConnector, AmazonConnector, TikTokShopConnector } = require("./apiConnectors");
...
const CHANNELS = [
  ...
  { id: "amazon",       label: "Amazon Seller Central", mode: "api",    setup: "CHANNEL_SETUP.md#amazon", optional: true },
  ...
  { id: "tiktok-shop",  label: "TikTok Shop",          mode: "api",    setup: "CHANNEL_SETUP.md#tiktok-shop", optional: true },
];
